...
class maho {
  ...
  API(id, method, data = null, promise = true, apid = null, callback){
  ...
  log(promise = true, callback = undefined){
    return this.API(1, "GET", promise, null, null, callback);
  }
  logDetails(promise = true, callback = undefined){
    return this.API(2, "GET", promise, null, null, callback);
  }
  kernel(data = null, method = "GET", promise = true, callback = undefined){
    // GET/POST
    return this.API(3, method, data, promise, null, callback);
  }
  subsListId(id, promise = true, callback = undefined){
    return this.API(4, "GET", null, promise, id, callback);
  }
  subsList(data = null, method = "GET", promise = true, callback = undefined){
    // GET/PATCH
    return this.API(5, method, data, promise, null, callback);
  }
  subs(data = null, promise = true, callback = undefined){
    return this.API(6, "PUT", data, promise, null, callback);
  }
  subsId(id, promise = true, callback = undefined){
    return this.API(7, "DELETE", null, promise, id, callback);
  }
  subsInfos(data = null, method = "GET", promise = true, callback = undefined){
    // GET/POST
    return this.API(8, method, data, promise, null, callback);
  }
  ctxId(id, data = null, promise = true, method = "GET", callback = undefined){
    // GET/PUT
    return this.API(9, method, data, promise, id, callback);
  }
  proxies(promise = true, callback = undefined){
    return this.API(10, "GET", null, promise, null, callback);
  }
  maho(data = null, method = "GET", promise = true, callback = undefined){
    // GET/PATCH/PUT
    return this.API(11, method, data, promise, null, callback)
  }
  labels(promise = true, callback){
    return this.API(12, "GET", null, promise, null, callback);
  }
  list(promise = true, callback){
    return this.API(13, "GET", null, promise, null, callback);
  }
  listMode(data, promise = true, callback){
    return this.API(14, "PATCH", data, promise, null, callback);
  }
  listList(data, promise = true, callback){
    return this.API(15, "PATCH", data, promise, null, callback);
  }
  mode(data, promise = true, callback){
    return this.API(16, "PATCH", data, promise, null, callback);
  }
  box(promise = true, callback){
    // return: 喵
    return this.API(17, "GET", null, promise, null, callback);
  }
  boxLog(data = null, method = "GET", promise = true, callback){
    // GET/PUT
    return this.API(18, method, data, promise, null, callback);
  }
  boxNTP(data = null, method = "GET", promise = true, callback){
    // GET/PUT
    return this.API(19, method, data, promise, null, callback);
  }
  boxDNS(data = null, method = "GET", promise = true, callback){
    // GET/PATCH
    return this.API(20, method, data, promise, null, callback);
  }
  fakeip(data = null, method = "GET", promise = true, callback){
    // GET/PUT
    return this.API(21, method, data, promise, null, callback);
  }
  dns(data = null, method = "GET", promise = true, callback){
    // GET/PUT/PATCH
    return this.API(22, method, data, promise, null, callback);
  }
  dnsID(id, data = null, method = "GET", promise = true, callback){
    // GET/DELETE
    return this.API(23, method, data, promise, id, callback);
  }
  dnsRules(data = null, method = "GET", promise = true, callback){
    // GET/PATCH
    return this.API(24, method, data, promise, null, callback);
  }
  inbounds(data = null, method = "GET", promise = true, callback){
    // GET/PATCH
    return this.API(25, method, data, promise, null, callback);
  }
  outboundsID(id, data = null, method = "GET", promise = true, callback){
    // GET/DELETE
    return this.API(26, method, data, promise, id, callback);
  }
  outbounds(data = null, method = "GET", promise = true, callback){
    // GET/PUT/PATCH
    return this.API(27, method, data, promise, null, callback);
  }
  route(data = null, method = "GET", promise = true, callback){
    // GET/PATCH
    return this.API(28, method, data, promise, null, callback);
  }
  routeRules(promise = true, callback){
    return this.API(29, "GET", null, promise, null, callback);
  }
  exp(promise = true, callback){
    return this.API(30, "GET", null, promise, null, callback);
  }
  expClash(promise = true, callback){
    return this.API(31, "GET", null, promise, null, callback);
  }
  expV2ray(promise = true, callback){
    return this.API(32, "GET", null, promise, null, callback);
  }
  config(data = null, promise = true, callback){
    return this.API(33, "PUT", data, promise, null, callback);
  }
}
